...
public class TaskFilterController {
  ...
  public TaskResponseDto responseDto(Task task) {
    return new TaskResponseDto(
        task.getTaskType(), task.getDescription(), task.getTaskStatus(), task.getExecutionDate());
  }
  ...
  ResponseEntity<Page<TaskResponseDto>> getAllTasksSortedAndPaginated(
    ...
    Page<TaskResponseDto> allTasksSortedAndPaginated =
        taskFilterService.getAllTasksSortedAndPaginated(pageNo, pageSize, field, direction);
    return ResponseEntity.ok().body(allTasksSortedAndPaginated);
  }
  ...
  ResponseEntity<List<TaskResponseDto>> getWarnedTasks() {
    ...
    return ResponseEntity.ok().body(warnedTasks);
  }
  ...
  ResponseEntity<List<TaskResponseDto>> getExpiredTasks() {
    ...
    return ResponseEntity.ok().body(expiredTasks);
  }
  ...
  ResponseEntity<List<TaskResponseDto>> getTasksAssignedToUser(@RequestParam String login) {
    List<TaskResponseDto> assignedTasksToUser = taskFilterService.getAssignedTasksToUser(login);
    return ResponseEntity.ok().body(assignedTasksToUser);
  }
  ...
  ResponseEntity<List<TaskResponseDto>> getTasksByStatus(@RequestParam String status) {
    ...
    return ResponseEntity.ok().body(taskByStatus);
  }
  ...
  ResponseEntity<List<TaskResponseDto>> getTasksByCreationDateRange(
    ...
    List<TaskResponseDto> taskByCreationDateRange =
        taskFilterService.getTaskByCreationDateRange(filterDto);
    return ResponseEntity.ok().body(taskByCreationDateRange);
  }
  ...
  ResponseEntity<List<TaskResponseDto>> getTasksByExecutionDateRange(
    ...
    TaskFilterDto filterDto = new TaskFilterDto(startDate, endDate);
    List<TaskResponseDto> taskByExecutionDateRange =
        taskFilterService.getTaskByExecutionDateRange(filterDto);
    return ResponseEntity.ok().body(taskByExecutionDateRange);
  }
